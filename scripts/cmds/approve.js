...
module.exports = {
  ...
  onStart: async function ({ event, api, args }) {
    ...
    if (command === "list") {
      ...
      const adminFbLink = `https://www.facebook.com/${adminUID}`;
